    ...
    <div className="flex flex-col min-h-[100dvh]">
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col justify-center items-center space-y-4">
              <div className="space-y-2 text-center">
                ...
                Real-Time Chat for Your Health Needs
                </h1>
                <p className="max-w-[600px] mx-auto text-muted-foreground md:text-xl">
                  Overcome language barriers and connect with doctors from around
      ...
      <footer className="sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-center text-muted-foreground">
          &copy; {new Date().getFullYear()} med-o-next. All rights reserved.
        </p>
      </footer>
    </div>
  );
